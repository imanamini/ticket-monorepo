...
@Component({
  selector: 'app-ui-dialog-thanks-msg',
  templateUrl: './ui-dialog-thanks-msg.component.html',
  styleUrls: ['./ui-dialog-thanks-msg.component.scss'],
  standalone: true,
  imports: [NgOptimizedImage, NgIf, UiButtonComponent, NgxIcon],
})
export class UiDialogThanksMsgComponent {
  templateData: any = {};
