...
@Component({
  selector: 'app-service-art-card',
  templateUrl: './service-art-card.component.html',
  styleUrls: ['./service-art-card.component.scss', '../base-style.scss'],
  standalone: true,
  imports: [NgClass, NgFor, NgStyle],
})
export class ServiceArtCardComponent implements OnInit {
  @Input()
  images: Array<{
    image: ApiFile;
  }> = [];
