...
import { AppComponent, EnvironmentService } from '@client-monorepo/app-core';
...
// Set environment for static access throughout the app
...
bootstrapApplication(AppComponent, appConfig)
  ...
  .catch((err) => console.error('Bootstrap failed', err instanceof Error ? err : new Error(String(err))));
