...
import { PAYMENT_CREDIT_CARD_CONFIG } from '../../../data-access/consts/payment-method-card-config';
...
export class PaymentCreditCard implements PaymentMethodStrategyInterface {
  ...
  public config(): CardConfigInterface {
    return PAYMENT_CREDIT_CARD_CONFIG;
  }
}
