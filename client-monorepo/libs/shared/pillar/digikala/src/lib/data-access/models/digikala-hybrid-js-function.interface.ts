...
export type NavigationTabState = { variant: 'hidden' | 'compact'; height: number };

interface IDigikalaSuperAppJsFunction {
  /**
...
export interface DigikalaSuperAppWindow extends Window {
  SuperAppApi: IDigikalaSuperAppJsFunction;
}
