...
export const environment: IEnvironment = {
  production: true,
  callbackUrl: 'https://wealth.mydigipay.ir/ipg-callback',
  supperAppLoginUrl: '',
  afterLoginUrl: '',
  clientMetadata: 'https://wealth.mydigipay.ir/ipg-callback',
  isWealthDomain: true,

  baseApiUrl: '/api/',
  sentry_dsn:
    'https://5b79c29dfd1b4211b822caea2dd1fc33@sentry.mydigipay.info/93',
  ...
  android_hybrid_password:
    'hybrid-android-client-secert-ddd6c372-c3a0-4964-8faa-7b57d76f573b',
  ios_hybrid_username: 'hybrid-ios-client-id',
  ios_hybrid_password:
    'hybrid-ios-client-secert-88b40c21-6c9b-42e9-8191-1d1a22664f44',
  google_tag_manager_id: 'GTM-PS2XTV5J',
  intrackConfig: {
    app_key: 'AAAAeQ',
    auth_key: '37d18dc1-4f9a-4c90-af48-e599f288397e',
    public_key:
      'BGo62NtHnoQ3p38ApWww7f6QNf_l3MQ0GiLdvo_87z2D6harVPceaCSwnJov77qnfgJPtqbixrUR3ql177Ga9gI=',
