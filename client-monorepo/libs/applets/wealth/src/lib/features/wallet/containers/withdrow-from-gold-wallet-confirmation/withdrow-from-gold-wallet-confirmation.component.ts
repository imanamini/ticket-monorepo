...
@Component({
  selector: 'wealth-applet-withdrow-from-gold-wallet-confirmation',
  standalone: true,
  imports: [CommonModule, NgxButtonComponent, NgxCalloutComponent, NgxDividerComponent, PipesModule, NgxAppBarComponent, NgxIcon],
  templateUrl: './withdrow-from-gold-wallet-confirmation.component.html',
  styleUrl: './withdrow-from-gold-wallet-confirmation.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WithdrowFromGoldWalletConfirmationComponent implements OnInit {
