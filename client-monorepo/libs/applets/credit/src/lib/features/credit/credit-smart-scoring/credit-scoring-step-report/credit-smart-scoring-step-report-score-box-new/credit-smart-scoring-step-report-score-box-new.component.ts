...
@Component({
  selector: 'ui-cs-smart-score-box-new',
  templateUrl: './credit-smart-scoring-step-report-score-box-new.component.html',
  standalone: true,
  styleUrls: ['./credit-smart-scoring-step-report-score-box-new.component.scss'],
  imports: [PipesModule, NgxButtonComponent, NgxTrackableIdDirective],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CreditSmartScoringStepReportScoreBoxNewComponent {
  radius = 100;
  strokeWidth = 12;
  circleStrokeWidth = 4;
  startAngle = 180;
