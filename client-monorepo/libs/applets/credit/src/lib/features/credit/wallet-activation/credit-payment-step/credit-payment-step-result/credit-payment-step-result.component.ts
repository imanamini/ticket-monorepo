...
@Component({
  selector: 'app-credit-payment-step-result',
  templateUrl: './credit-payment-step-result.component.html',
  styleUrls: ['./credit-payment-step-result.component.scss'],
  standalone: true,
  imports: [NgxPaymentResult],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CreditPaymentStepResultComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.paymentResultService
      ...
      .catch((error) => {
        console.error('[CreditPaymentStepResult] Error getting payment result:', error);
        this.ready.set(true);
