...
@Component({
  selector: 'app-credit-scoring-score-details',
  templateUrl: './credit-scoring-step-score-details.component.html',
  styleUrls: ['./credit-scoring-step-score-details.component.scss'],
  standalone: true,
  imports: [PipesModule, NgxButtonComponent, NgxTrackableIdDirective, NgxBottomSheetHeaderComponent],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CreditScoringStepScoreDetailsComponent implements OnInit {
