...
export class ReceiptComponent implements OnInit {
  ...
  public getTicketInfo(): void {
    this.isLoading = true;
    this.walletApi.getDirectDebitTicketInfo(this.decodedData.ticket)
      .subscribe((response) => {
  ...
  private getContractInfo(): void {
    this.walletApi.getDirectDebitContractInfo(this.decodedData.contractId, this.decodedData.ticket)
      .subscribe((response) => {
