...
import { AbstractControl, ControlValueAccessor, UntypedFormBuilder, UntypedFormGroup, NG_VALUE_ACCESSOR, ValidationErrors, } from '@angular/forms';
 ...
 * @property {String | Boolean} errorMessage Show bottom of field if has truly value
...
export class FormFieldComponent implements OnInit, ControlValueAccessor, OnChanges {
  ...
  @Input() errorMessageMapper: {[key: string]: string};
  ...
  defaultErrorMessageMapper: {[key: string]: string} = {
