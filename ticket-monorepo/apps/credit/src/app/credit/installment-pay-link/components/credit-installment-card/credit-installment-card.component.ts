...
import { ClickStopPropagationDirective } from '../../../shared/directives/stop-propagation-directive';

@Component({
  selector: 'app-credit-installment-card',
  standalone: true,
  imports: [CommonModule, NgxDividerComponent, NgxCheckboxComponent, NgxBadgeModule, NgxButtonComponent, PipesModule, ClickStopPropagationDirective],
